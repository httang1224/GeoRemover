...
export OUTPUT_DIR="./stage1_ckpt"

accelerate launch diffusers/examples/advanced_diffusion_training/train_dreambooth_lora_flux_fill_stage1_rord_depth_dpo.py \
